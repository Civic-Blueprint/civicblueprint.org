  ...
  return (
    <section id="memo" className="section-shell relative overflow-hidden">
      ...
      <div className="container-shell relative grid gap-8 lg:grid-cols-2">
        <div>
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-blueprint-navy">
        ...
        <article className="blueprint-card corner-marks p-8">
          ...
          <ul className="mb-5 list-disc space-y-2 pl-5 text-slate">
